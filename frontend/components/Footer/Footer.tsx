...
function TelegramIcon() {
  return (
    <svg className={styles.messengerIcon} viewBox="0 0 24 24" fill="currentColor" aria-hidden>
...
const MESSENGERS = [
  { key: 'telegram', href: SITE_CONTACTS.telegram, label: 'Telegram', Icon: TelegramIcon },
  { key: 'whatsapp', href: SITE_CONTACTS.whatsapp, label: 'WhatsApp', Icon: WhatsAppIcon },
] as const;
            ...
            <div className={styles.links}>
              <div className={styles.phoneRow}>
                ...
                <div className={styles.messengerIcons}>
                  {MESSENGERS.map(({ key, href, label, Icon }) => (
                    <a
                      key={key}
                      href={href}
